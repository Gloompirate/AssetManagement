<?php
	...
	$yepAssets = ['YEPLaptops',['LAP-YEP1','LAP-YEP3','LAP-YEP3','LAP-YEP4','LAP-YEP6']];
	$assetsList = [$everymanAssets, $playhouseAssets, $pdqsAssets, $laptopAssets, $tabletAssets, $yepAssets];
	$jsonAssets =  json_encode($assetsList);
	$file = fopen('assets.json', 'w') or die('Unable to open file!');
	fwrite($file, $jsonAssets); 
	fclose($file);
	echo $jsonAssets;
?>
